package alic.malorodow.geoguessr_app.domain.model.profile
 ...
 * 4.5 „Profile Screen“).
 *
 * HINWEIS: Im Gegensatz zu den anderen, Domain-Modellen (z. B. [GeoLocation], [GeoCoordinate])
 * importiert diese Klasse mit [PropertyName] direkt eine Firebase-spezifische
 ...
 * Frameworks bleiben soll.
 *
 * Der Grund: Firebase Realtime atabase mappt Datenbankfelder standardmäßig über
 * den Property-Namen. Die Annotationen stellen sicher, dass das Mapping auch bei
...
data class PlayerProfile(
    ...
    // PlayerProfile() automatisch als Gast gilt, ohne dass jeder Aufrufer isGuest separat
    // setzen müsste.
